...
admissions_omr |>  ggplot(mapping = aes(x = weight_lbs)) +
  geom_histogram(color = "white", fill = "royalblue4") +
...
admissions_omr |>  ggplot(mapping = aes(x = height_inches)) +
  geom_histogram(color = "white", fill = "royalblue4") +
...
admissions_omr |>  ggplot(mapping = aes(x = bmi_kgm2)) +
  geom_histogram(color = "white", fill = "royalblue4") +
...
admissions_omr |> ggplot(mapping = aes(x = systolic_bp, y = diastolic_bp)) +
...
admissions_omr |> ggplot(mapping = aes(x = weight_lbs, y = height_inches)) +
  geom_point(alpha = 0.1, color = "royalblue4") +
  geom_smooth(se = FALSE, method = "lm", color = "white") +
...
admissions_omr |> ggplot(mapping = aes(x = weight_lbs, y = bmi_kgm2)) +
  geom_point(alpha = 0.1, color = "royalblue4") +
  geom_smooth(se = FALSE, method = "lm", color = "white") +
...
admissions_omr |> ggplot(mapping = aes(x = bmi_kgm2, y = insurance)) +
...
admissions_omr |> ggplot(mapping = aes(x = bmi_kgm2, y = language)) +
  geom_boxplot(color = "royalblue4", fill = "white", varwidth = TRUE) +
...
# bivariate graph for language and bmi
admissions_omr |> ggplot(mapping = aes(x = bmi_kgm2, y = marital_status)) +
  geom_boxplot(color = "royalblue4", fill = "white", varwidth = TRUE) +
...
admissions_omr |> ggplot(mapping = aes(x = bmi_kgm2, y = ethnicity)) +
  geom_boxplot(color = "royalblue4", fill = "white", varwidth = TRUE) +
